 ...
 */
  ...
  KEYMAP_DIRECTIONAL(
      KC_GRV, KC_F1 , KC_F2 , KC_F3 , KC_F4 , KC_F5 , KC_F6 , KC_F7 , KC_F8 , KC_F9 , KC_F10, KC_F11, KC_F12, ______, RGB_TOG,
 ...
 * |         | Hue+| Hue-| Sat+| Sat-|     |     |     |     |     |     |     |             |
 * |-----------------------------------------------------------------------------------------+
 * |           |BREATHE|RAINBOW|GRADIENT|SWIRL|STATIC|KNIGHT|SNAKE|     |     |     |     | MO+ |     |
 * |-----------------------------------------------------------------------------------------+
 * |      |       |       |                                   |     |      |L_MO | MO-| R_MO |
 * `-----------------------------------------------------------------------------------------'
 */
  ...
  KEYMAP_DIRECTIONAL(
      ...
      ______, RGB_MOD, RGB_RMOD, ______, ______, ______, ______, ______, ______, ______, ______, RGB_VAI, RGB_VAD, ______,
      ______, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, ______, ______, ______, ______, ______, ______, ______, 
      ______, ______, RGB_M_B, RGB_M_R, RGB_M_G, RGB_M_SW, RGB_M_P, RGB_M_K, RGB_M_SN, ______, ______, ______, ______, ______, ______,
      ______, ______, ______, ______, ______, ______, ______, KC_PGUP, KC_PGDOWN, ______, ______ 
      ),
};
